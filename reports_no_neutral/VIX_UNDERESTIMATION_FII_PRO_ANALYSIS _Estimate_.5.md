...
VIX overestimates intraday range ~40% of the time. The 59.9% of days where it underestimates are the high-volatility outlier days — and understanding which FII/PRO combinations precede these events is the focus of this report.
...
**Key insight**: Bearish Alignment has the highest underestimation rate (66.1%). When both FII and PRO lean in this direction, the market is more likely to produce a larger-than-expected move.
...
**Takeaway**: When both sides are bearish, the combinations with mixed conviction intensity (e.g., Mildly Bearish × Strong Bearish) tend to show the highest underestimation rates. The gap in conviction intensity appears to produce unstable price action.
...
When VIX underestimates on bullish alignment days, the market still closes RED 53.9% of the time — meaning the excess volatility tends to work against the bullish institutional view.
...
Elevated VIX (20-30) typically has the highest underestimation rate. When VIX is already signaling heightened volatility, it still underestimates a significant portion of trading days.
...
1. **Bearish Alignment = highest underestimation risk** (66.1%): When both FII and PRO lean in this direction, VIX underestimates ~1 in 2 days with outsized moves.
2. **Highest underestimation combo**: Bearish FII + Mildly Bullish PRO — **81.8%** underestimation rate across 11 days.
3. **Bearish alignment is more volatile than bullish**: Bearish at 66.1% vs Bullish at 56.5% underestimation (+9.6 pp gap). Bearish institutional flow is a stronger predictor of excess volatility.
4. **Elevated VIX (20-30) amplifies**: Even when VIX is already signaling high volatility, it underestimates 58.0% of the time.
5. **Temporal clusters**: Mondays (63.8%) are most prone to underestimation. Tuesdays (56.3%) are safest.
6. **Extreme outliers**: The largest VIX misses often occur in combinations where positioning doesn't fully explain the move — suggesting exogenous shocks (geopolitical, macro, election results) drive the most extreme blowouts.

---

## Trading Implications

- **Size options wider** for these combos (≥20% underestimation rate, ≥10 days): Bearish+Mildly Bullish (82%), Strong Bearish+Strong Bearish (75%), Strong Bearish+Mildly Bearish (70%), Bearish+Bearish (69%), Bearish+Strong Bearish (68%)
- On high-risk days (bearish alignment + elevated VIX + Friday), consider buying premium or widening stop-losses
